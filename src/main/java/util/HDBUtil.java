...
public class HDBUtil implements DBUtil {
	...
	/**
	 * Вносит изменения в экземпляр объекта из базы данных, взятые из экземпляра объекта
	 * переданного пользователем 
	 * @param res - экземпляр объекта, переданного пользователем
	 * @param dest - экземпляр объекта из базы данных
	 */
